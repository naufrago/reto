...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-06-2017 a las 03:24:46
...
INSERT INTO `nivel_keys` (`id_key`, `nombre_key`) VALUES
(1, 'hexadecimal'),
(2, '1''or1=''1'),
(3, 'plotkey1.2'),
(4, 'full-xss-test'),
...
--
ALTER TABLE `niveles`
  MODIFY `id_nivel` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=16;
--
